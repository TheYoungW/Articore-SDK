...
def compute_inverse_dynamics(
    ...
    示例:
        .. code-block:: python
            ...
            from teleop.adapters.arm.arx_d_can.dynamics import compute_inverse_dynamics
...
def compute_generalized_gravity(
    ...
    示例:
        .. code-block:: python
            ...
            from teleop.adapters.arm.arx_d_can.dynamics import compute_generalized_gravity

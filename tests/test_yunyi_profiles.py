...
def test_yunyi_control_gains_follow_actuator_capability_tiers() -> None:
    ...
    medium_joint3 = (60.0, 4.0, 0.0125, 0.001, 165.0, 0.0, 1.8)
    medium_joint4 = (60.0, 4.0, 0.0125, 0.001, 180.0, 0.0, 1.8)
    low = (18.0, 2.0, 0.006, 0.0015, 80.0, 0.2, 2.0)
    expected = [
        high_damped,
        high_soft,
        medium_joint3,
...
def test_yunyi_profiles_share_one_authoritative_dual_arm_urdf() -> None:
    ...
    for side in ("r", "l"):
        ...
        assert float(joint4_limit.attrib["lower"]) == pytest.approx(math.radians(-90.0))
        ...
        assert profile_joint4.lower_limit == pytest.approx(math.radians(-90.0))

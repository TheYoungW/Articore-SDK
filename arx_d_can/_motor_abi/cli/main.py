...
def _add_run_args(p: argparse.ArgumentParser) -> None:
    ...
    p.add_argument("--feedback-timeout-ms", type=int, default=1000)
    p.add_argument("--verify-model", type=int, default=1)
    p.add_argument("--verify-timeout-ms", type=int, default=1000)
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Articore-SDK native Damiao CLI", allow_abbrev=False)
    ...
    scan.add_argument("--timeout-ms", type=int, default=1000)
    ...
    dump.add_argument("--timeout-ms", type=int, default=1000)
    ...
    set_id.add_argument("--timeout-ms", type=int, default=1000)
    ...
    for name, writer in (("damiao-read-param", False), ("damiao-write-param", True)):
        ...
        cmd.add_argument("--timeout-ms", type=int, default=1000)
        if writer:
...
def _parse_args() -> argparse.Namespace:
    ...
    if (
        ...
        legacy = argparse.ArgumentParser(description="Articore-SDK native Damiao CLI", allow_abbrev=False)
...
def main() -> None:
    ...
    try:
        ...
        hint = preflight_can_runtime("Articore-SDK", args.transport, args.channel)
        if hint:
